...
print("##                                                                        ##");
print("##  Button       The Button widget is used to display buttons in          ##");#print("https://www.tutorialspoint.com/python3/tk_button.htm")
...
class iniciar7_pantalla_raiz( Frame ):
    def __init__( self ):
        ...
        self.button2 = Button( self, text = "cerrar", width = 25, command =  self.windows_cerrar )
...
class funcion_2(Frame): 
    def __init__(self):
        ...
        new.button = tk.Button(  text = "Cierro", width = 25,command = windows_cerrar )
        new.button.pack()
    def windows_cerrar(self):
        self.destroy()
def main():
...
def iniciar14_pantalla_raiz():
	...
	Item_Menu.add_command(label = "Salir", command = pantalla_raiz.quit)

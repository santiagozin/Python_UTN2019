...
print("############################################################################");
print("##                                                                        ##");
print("##                         manejo de eventos                              ##");
print("##                            scheduler                                   ##");
print("##                         libreria sched                                 ##");
print("##                                                                        ##");
print("##            enterabs()    Inicia en un momento específico               ##");
print("##                  time                                                  ##");
print("##                  priority                                              ##");
print("##                  action                                                ##");
print("##                  argument=()                                           ##");
print("##                  kwargs={}                                             ##");
print("##                                                                        ##");
print("##            enter()       Inicia en un lapso de espera                  ##");
print("##                  delay                                                 ##");
print("##                  priority                                              ##");
print("##                  action                                                ##");
print("##                  argument=()                                           ##");
print("##                  kwargs={}                                             ##");
print("##                                                                        ##");
print("##            cancel()      Cansela mientras el evento este en cola       ##");
print("##                          o no haya empezado a ejecutarse               ##");
print("##                                                                        ##");
print("##            empty()       Devuelve si quedan eventos pendientes.        ##");
print("##                                                                        ##");
print("##            queue         Devuelve los eventos pendientes de ejecución. ##");
print("##                                                                        ##");
print("##            run()         Inicia o poner en marcha el programador.      ##");
print("##                                                                        ##");
print("##                                                                        ##");
print("############################################################################");
print("##                                                                        ##");
print("##   Los dos métodos tienen los siguientes argumentos:                    ##");
print("##                                                                        ##");
print("##   time/delay: en entertabs() define el momento de ejecución del evento ##");
print("##     y en enter() el tiempo de espera. El valor expresado debe ser      ##");
print("##     compatible con el valor devuelto por la función indicada como      ##"); 
print("##     primer argumento del constructor scheduler().                      ##");
print("##                                                                        ##");
print("##   priority: establece la prioridad de ejecución cuando dos o más       ##");
print("##     eventos tienen el mismo momento de ejecución. Cuanto más bajo es   ##");
print("##     el número mayor prioridad tiene.                                   ##");
print("##                                                                        ##");
print("##   action: es la función a ejecutar.                                    ##");
print("##                                                                        ##");
print("##   argument: normalmente, es una tupla con los valores de los           ##");
print("##     argumentos de la función de action. Opcional.                      ##");
print("##                                                                        ##");
print("##   kwargs: es un diccionario que se puede pasar como argumento de la    ##");
print("##     función de action. Opcional.                                       ##");
print("##                                                                        ##");
print("##     Scheduler.add(intervalo, repeticiones, funcion, argumentos,        ##");
print("##                                           argumentos_por_nombre)       ##");
print("##                                                                        ##");
print("############################################################################");
print("##       https://argentinaenpython.com/quiero-aprender-python/            ##");
print("############################################################################");

print("https://pymotw.com/2/sched/");
print("https://pymotw.com/3/sched/");

print("https://python-para-impacientes.blogspot.com/2017/03/");
def limpiar():
    import os
    if os.name == 'nt':
        os.system('cls')
...
'''
print (input("Fin Ej 016_1 \n		continuar?"));
limpiar();
print("############################################################################"); 
# Ej 016_2
print("Inicio Ej 016_2");
print("""
...
'''
print (input("Fin Ej 016_2 \n		continuar?"));
limpiar();
print("############################################################################"); 
# Ej 016_3
print("Inicio Ej 016_1-3");
print("""
...
""");
print (input("Fin Ej 016_3 \n		continuar?"));
limpiar();
print("############################################################################"); 
# Ej 016_4
print("Inicio Ej 016_4");
import sched
import time
...
'''
print (input("Fin Ej 016_4 \n		continuar?"));
limpiar();
print("############################################################################"); 
# Ej 016_5
print("Inicio Ej 016_1-5");
print("""

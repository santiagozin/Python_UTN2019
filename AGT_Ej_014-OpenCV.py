...
print("##            * Introducción a cv2S y comparativa con SVN                 ##");
...
print("Para finalizar veremos como calcular el umbral más optimo de manera automática, la elección del mismo suele ser una tarea difícil, OpenCV nos facilita el trabajo implementando los métodos: THRESH_OTSU o THRESH_TRIANGLE, veamos como se utiliza esta opción.");
